...
const LotsPage = ({ onNavigateToHome, onNavigateToAmenities }) => {
  ...
  const phases = [
    {
      ...
      description:
        "Perched on elevated terrain with views of the Sierra Madre mountain range and greenery below.",
    ...
    },
    {
      ...
      textColor: "text-white",
      description:
        "Backyards overlooking Eastridge Golf course's manicured fairways with a few prime lots adjacent to hole #10.",
    ...
    },
    {
      ...
      description:
        "Overlooking the tranquil waters of Laguna Lake and the Metro Manila skyline beyond.",
          ...
          <div className="relative z-10 h-full w-full">
            ...
            >
              ...
              <div className="absolute inset-0 z-20 flex items-center justify-center">
                <div
                  className="max-w-4xl mx-auto px-4 md:px-6 font-bold mx-[300px] my-[0px]"
                ...
                >
                  ...
                  >
                    A place to call yours is more than just a feat — it's peace
                    of mind.
                  </motion.p>
                </div>
              </div>
                  ...
                  <div className="text-center">
                    ...
                    >
                      ...
                      <p className="font-rotunda text-lg md:text-xl lg:text-2xl xl:text-3xl max-w-4xl mx-auto leading-relaxed text-[#4A573B]/90">
                        Choose from exclusive land parcels with breathtaking
                        cliffside, fairway, and lake views. Each lot offers the
                        perfect foundation for your elevated lifestyle at Narra
                        Cliffs.
                      </p>

                      <div className="pt-4 md:pt-6 lg:pt-8">
                        <p className="font-rotunda text-base md:text-lg lg:text-xl text-[#4A573B]/80 mb-4">
                          <span className="font-bold text-[#DA743F]">
                            Limited availability
                          </span>{" "}
                          • Premium locations • Ready for development
                        </p>
          ...
          <div className="relative z-10" style={{ backgroundColor: "#CEC6AD" }}>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 pt-8 pb-12 md:pb-16">
              ...
              >
                ...
                >
                  the dramatic Cliffside, the serene Fairway, or the tranquil
                  Lakeview—each phase offering unique vistas and premier
                  selections.
                </motion.p>
              </motion.div>
            </div>
              ...
              >
                {phases.map((phase, index) => (
                  ...
                  >
                    ...
                    <motion.div
                      className={`flex items-center justify-center py-8 px-6 rounded-lg ${phase.bgColor}`}
                    >
                      <div className="space-y-6 max-w-lg">
                        ...
                        >
                          <phase.icon
                            className={`w-10 h-10 md:w-12 md:h-12 ${phase.textColor}`}
                          />
                        </motion.div>
                        ...
                        <h3
                          className={`font-garamond text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-8 ${phase.textColor}`}
                        >
                          {phase.customTitle || phase.name}
                        </h3>
                        <p
                          className={`font-rotunda text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-justify ${
                            phase.textColor === "text-white"
                              ? "text-gray-200"
                              : "text-gray-700"
                          }`}
                        >
              ...
              <div className="relative w-full h-[600px] lg:h-[700px] overflow-hidden">
                        ...
                        >
                          <div className="space-y-8 max-w-2xl">
                            <motion.div>
                              ...
                              >
                                <phase.icon
                                  className={`w-12 h-12 lg:w-16 lg:h-16 xl:w-20 xl:h-20 ${phase.textColor}`}
                                />
                              </motion.div>
                            ...
                            <motion.p
                              className={`font-rotunda text-lg lg:text-xl xl:text-2xl 2xl:text-3xl leading-relaxed text-justify ${
                                phase.textColor === "text-white"
                                  ? "text-gray-200"
                                  : "text-gray-700"
                              }`}
                ...
                <div className="absolute bottom-0 left-0 w-full h-1 bg-black/10">
                  <motion.div
                    ...
                    initial={{ width: "0%" }}
                    animate={{
                      width: `${((currentSlide + 1) / phases.length) * 100}%`,
                    }}
